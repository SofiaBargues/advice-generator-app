  ...
  return (
    <div className="bg-darkBlue font-manrope h-screen  flex flex-col justify-center ">
      <div className="bg-darkGrayish pb-[55px] h-[332px] w-[343px] md:h-[332px] md:w-[540px] m-auto rounded-xl justify-evenly p-[24px] flex flex-col items-center relative ">
        ...
        <div className="text-lightCyan font-bold text-2xl text-center">
          {advice}
        </div>
        {/* separator */}
        <div className="  flex flex-row gap-2 justify-center items-center ">
          <div className="bg-lightCyan  h-[1px] w-28 md:w-[200px]"></div>
          <div className="h-5 rounded-md w-[6px] bg-lightCyan"></div>
          <div className="h-5 rounded-md w-[6px] bg-lightCyan"></div>
          <div className="bg-lightCyan  h-[1px] w-28 md:w-[200px]"></div>
        </div>
        <button
          onClick={handleClick}
          className="bg-neonGreen hover:shadow-[#52ffa8_0px_0px_30px_0px]  absolute left-[130px] top-[280px]  md:left-[230px] md:top-[280px] rounded-full w-[80px] aspect-square flex flex-col justify-center items-center"
        >
